         ...
         <div class="phone-view">
             ...
             <div class="phone-view-nav">
                 <ul class="nav flex-column">
                     ...
                     <li class="nav-item">
                         <a href="myproject.php" class="link123">My Project </br>
                             << Atal Parivahan</a> </li> </ul> </div> </div> <div class="nav-container123" id="first">
                                 ...
                                 <div class="nav-123">
                                     ...
                                     <a class="project-link1" href="myproject.php">
                                         <p>My Project </br> >> Atal Parivahan</p>
                                     </a>
                                 ...
                                 <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                                     ...
                                     <div class="carousel-inner">
                                         ...
                                         <div class="carousel-item  ">
                                             <picture></picture>
                                             <img src="img2/crsu1.jpg" class="d-block w-100 ist-img" alt="..."
                                                 height="auto">
                                             <div class="carousel-caption ">
                                 ...
                                 <div class="scroll-class">
                                     <div class="content-one">
                                         ...
                                         <p class="about-me">Curious mind, creative spirit, and a coder’s persistence —
                                             ...
                                             developer,
                                             I blend technical skills with design thinking to build websites that don’t
                                             just
                                             work, but connect with users. From crafting responsive layouts to
                                             fine-tuning
                                             database queries, I enjoy turning ideas into functional, visually appealing
                                             digital
                                             experiences. Eager to explore new tools, solve tricky problems, and grow
                                             into a
                                             full-stack developer who can create solutions that leave a lasting impact.
                                         </p>
                         ...
                         <div class="swiper-slide">
                             <div class="container">
                                 <div class="scroll-class">
                                     <h1>EDUCATION</h1>
                                     <div class="divider"></div>
                                     <p class="education-para">I am currently pursuing my Bachelor’s in Computer
                                         Applications
                                         (BCA)
                                         and have completed two years of study, with my third year in progress. Over the
                                         course of my
                                         academic journey, I have gained strong foundational knowledge in programming,
                                         web
                                         development, database management, and computer graphics. My education has not
                                         only
                                         equipped
                                         ...
                                         <div class="col-md-6">
                                             <div class="content-right">
                                                 <p class="description">
                                                     ...
                                                     scoring
                                                     90%. Maintained consistent academic excellence with a strong
                                                     performance
                                                     across all subjects.
                                                 </p>
                                             </div>
                         ...
                         <div class="swiper-slide">
                             <div class="container">
                                 <div class="scroll-class">
                                     ...
                                     <p class="skills-para">I am a BCA final-year student with a strong foundation in
                                         web
                                         development, programming, and database management. My skills include HTML, CSS,
                                         JavaScript and MySQL, enabling me to create dynamic and responsive websites. I
                                         am
                                         also proficient in using frameworks like Bootstrap for front-end design. My
                                         problem-solving abilities and attention to detail help me deliver high-quality
                                         code
                                     ...
                                     <div class="div-scrool-skillbar">
                                         ...
                                         <div class="knowledge">
                                             ...
                                             <p class="knowledge-para">
                                                 Final-year BCA student with hands-on experience in web development and
                                                 a
                                                 strong grasp of HTML, CSS, and JavaScript. Worked on projects including
                                                 the
